...
const FilterSidebar = ({showFilterPhone, setShowFilterPhone, filters, setFilters}) => {
  ...
  return (
    <div className={`${showFilterPhone ? "max-sm:fixed" : "max-sm:hidden"} max-sm:inset-0
    z-100 max-sm:h-screen max-sm:overflow-scroll bg-white rounded-lg
    shadow-sm border border-gray-200 h-fit sticky top-24 md:min-w-[300px]`}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          className='sm:hidden text-sm border text-gray-700 px-3 py-1
      ...
      no-scrollbar">
        ...
        <div className="flex items-center justify-between">
            ...
            rounded-md outline-indigo-500' onChange={onChangeSearch} value={search}/>
        </div>
        {/* Platform Filter */}
        <div>
