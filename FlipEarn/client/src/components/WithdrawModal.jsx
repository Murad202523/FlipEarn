      ...
      sm:h-auto flex flex-col">
        ...
        gap-4 p-4 overflow-y-scroll'>
          <div className="grid grid-cols-[2fr_3fr_1fr] items-center gap-2">
            Amount <input onChange={(e)=> setAmount(e.target.value)} value={amount}
            type='number' className='w-full px-2 py-1.5 text-sm
          ...
          {account.map((field, index)=>(
            ...
            items-center gap-2">
              ...
              text-sm border border-gray-300 rounded outline-indigo-400'/>
            </div>
          ))}
