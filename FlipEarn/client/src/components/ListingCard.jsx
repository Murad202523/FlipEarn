...
import { User, BadgeCheck, LineChart, MapPin } from 'lucide-react'
  ...
  return (
    ...
    border-gray-100 overflow-hidden hover:shadow-md transition'>
      ...
      <div className="p-5 pt-8">
        ...
        {/* Stats */}
        <div className="flex flex-wrap justify-between max-w-lg items-center gap-3
        my-5">
    ...
    <div className="flex items-center justify-between">
      ...
      className="px-7 py-3 bg-indigo-600 text-white text-sm rounded-lg
