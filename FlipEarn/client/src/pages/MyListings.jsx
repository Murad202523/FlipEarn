...
import { Edit, EyeIcon, EyeOffIcon, TrashIcon, Users } from 'lucide-react';
import { platformIcons } from '../assets/assets';
import StatCard from '../components/StatCard';
import { ArrowDownCircleIcon, BanIcon, CheckCircle, Clock, CoinsIcon, DollarSign, Eye, LockIcon, Plus, StarIcon, TrendingUp, WalletIcon, XCircle } from 'lucide-react';
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
     ...
     md:items-center mb-8">
      ...
      <button onClick={()=>navigate('/create-listing')} className='bg-indigo-600
      hover:bg-indigo-700 text-white px-6 py-2 rounded font-medium flex
      items-center space-x-2 mt-4 md:mt-0'>
              ...
              <div className="space-y-4">
                ...
                border-gray-200">
                  ...
                  <div className="flex items-center space-x-2">
                      ...
                      <button onClick={()=>toggleStatus(listing.id)} className='p-2 border border-gray-300 rounded-lg
    ...
    {/* Footer */}
      <div className="bg-white border-t border-gray-200 p-4 text-center mt-28">
        <p className="text-sm text-gray-500">
          © 2025 <span className="text-indigo-600">GreatStack</span>. All rights
           reserved.
        </p>
      </div>
    </div>
