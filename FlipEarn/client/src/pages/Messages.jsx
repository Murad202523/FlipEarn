    ...
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
      <div className='py-10'>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-xs border border-gray-200 p-16
          text-center">
                ...
                transition-colors text-left">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className={`text-sm truncate ${!chat.isLastMessageRead && chat.lastMessageSenderId !== user?.id ? 'text-indigo-600 font-medium' : "text-gray-500"}`}>{chat.lastMessage || "No messages yet"}
                      </p>
                    </div>
                  </div>
                </button>
